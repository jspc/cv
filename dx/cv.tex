...
{Ownership of internal platform services, with Disaster Recovery my main deliverable. As part of this I provide career coaching to members of my team, including training and mentorship}
...
{To architect, develop and rollout the FT's new flagship video platform, including custom config management tooling, container platform, consul backed routing and api driven monitoring based on shopify's \emph{dashing}, with logs being shipped into Splunk, and deploymemt artifacts being stored in Nexus.}
